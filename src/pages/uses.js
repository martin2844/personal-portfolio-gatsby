   ...
   return (
      <Layout>
         <Helmet>
            ...
            <meta
               name="description"
               content="This is what I use everyday, my tech, my hardware"
            />
         ...
         <section className="uses-title-section">
            ...
            <p>
               Welcome to my /uses, here is what I use daily for software &
               hardware
            </p>
         </section>
         <section className="uses-main-content">
            <div className="tech-box">
               <h1>Dev's tech</h1>
               <p>
                  Here is some of the tech I use! <br /> When it comes to
                  developing, I love javascript and it's versatility, so it is
                  what I mostly prefer. <br /> Of course I am not limited only
                  to these.
               </p>
               {logoMap}
            </div>
