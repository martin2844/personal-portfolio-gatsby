...
const Blog = () => {
   const postsQuery = useStaticQuery(graphql`
      query {
         ...
         images: allFile(
            ...
            filter: { sourceInstanceName: { eq: "thumbs" } }
         ) {
            edges {
               node {
                  childImageSharp {
      ...
      return (
         <ul className="post-container">
            <div className="post-container-img">
               <Link
                  className="no-decor"
                  to={`/blog/${posts.node.fields.slug}`}
               >
                  <Img fluid={theImage} />
               </Link>
            </div>
   ...
   const displayTags = filterTags.map((tag) => {
      let runTheFilter = (e) => {
         ...
         let arrayFilter;
         if (thePosts) {
            //if thePosts exists, begin filter using tag which is filtered word.
   ...
   return (
      <Layout>
         <Helmet>
            ...
            <meta
               name="description"
               content="My Blog, I write about stuff related to tech and web dev"
            />
         ...
         <section className="section-blog-title">
            ...
            <p>
               Every now and then I like writting about certain things, that are
               interesting to me in the world of web development
            </p>
         </section>
